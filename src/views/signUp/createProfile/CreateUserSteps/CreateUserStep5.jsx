...
const suggestedskills = [{ label: 'Testing', value: "testing" }, { label: 'Software QA', value: "qa" }, { label: 'Javascript', value: 'javascript' }, { label: 'React', value: 'react' }, { label: 'Web Design', value: 'desigining' }]
    ...
    return (
        <div className='wrapper mt-5 justify-content-start flex-column createprofile_wrapper my-4 w-100'>
            <div className='w-100 my-4'>
                ...
                <p style={{ width: "70%" }}>Your skills show clients what you can offer, and help us choose which jobs to recommend to you. Add or remove the ones we've suggested, or start typing to pick more. its up to you.  </p>
            </div>
                    ...
                    <div className='wrapper justify-content-start'>
                        {
                            suggestedskills.map((elem) => (
                                <div key={elem.label} onClick={() => handleSuggestedCLick(elem)} className='rounded-pill mx-2 px-2 skillspills wrapper justify-content-between'>
